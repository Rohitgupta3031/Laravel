  ...
  $(".sidebar-type li").on("click", function () {
    ...
    switch (type) {
      case "normal-sidebar": {
        ...
        $(".logo-wrapper")
          .find("img")
          .attr("src", "../assets/images/endless-logo.png");
        break;
      }
      case "compact-sidebar": {
        ...
        $(".logo-wrapper")
          .find("img")
          .attr("src", "../assets/images/logo/compact-logo.png");
        break;
      }
